...
const SkillItem = memo(({ skill }: { skill: TechnicalSkill }) => (
      ...
      <div className="grid lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-8">
          <Card className="p-8 glass hover-scale">
            ...
            <div className="flex flex-wrap gap-2">
              {softSkills.map((skill, i) => (
                <Badge key={i} variant="outline" className="glass hover:bg-primary/20 transition-colors">
                  {skill}
                </Badge>
              ))}
            </div>
          ...
          <Card className="p-8 glass hover-scale">
            ...
            <div className="flex flex-wrap gap-2">
              {tools.map((tool, i) => (
                <Badge key={i} variant="outline" className="glass hover:bg-secondary/20 transition-colors">
                  {tool}
                </Badge>
              ))}
            </div>
